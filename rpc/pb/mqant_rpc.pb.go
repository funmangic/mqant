...
type CallBackQueueMsg struct {
	...
	Bodies    [][]byte `protobuf:"bytes,3,rep,name=bodies,proto3" json:"bodies,omitempty"`
}

func (x *CallBackQueueMsg) Reset() {
	*x = CallBackQueueMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mqant_rpc_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CallBackQueueMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CallBackQueueMsg) ProtoMessage() {}

func (x *CallBackQueueMsg) ProtoReflect() protoreflect.Message {
	mi := &file_mqant_rpc_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CallBackQueueMsg.ProtoReflect.Descriptor instead.
func (*CallBackQueueMsg) Descriptor() ([]byte, []int) {
	return file_mqant_rpc_proto_rawDescGZIP(), []int{2}
}

func (x *CallBackQueueMsg) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *CallBackQueueMsg) GetTopics() []string {
	if x != nil {
		return x.Topics
	}
	return nil
...
func (x *CallBackQueueMsg) GetBodies() [][]byte {
	if x != nil {
		return x.Bodies
	}
	return nil
...
var file_mqant_rpc_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x61, 0x0a, 0x10, 0x43, 0x61, 0x6c, 0x6c,
	0x42, 0x61, 0x63, 0x6b, 0x51, 0x75, 0x65, 0x75, 0x65, 0x4d, 0x73, 0x67, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x69, 0x63, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x6f, 0x64, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0c, 0x52, 0x06, 0x62, 0x6f, 0x64, 0x69, 0x65, 0x73, 0x42, 0x26, 0x5a, 0x24, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x75, 0x6e, 0x6d, 0x61, 0x6e,
	0x67, 0x69, 0x63, 0x2f, 0x6d, 0x71, 0x61, 0x6e, 0x74, 0x2f, 0x72, 0x70, 0x63, 0x2f, 0x72, 0x70,
...
var file_mqant_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mqant_rpc_proto_goTypes = []interface{}{
	(*RPCInfo)(nil),          // 0: rpcpb.RPCInfo
	(*ResultInfo)(nil),       // 1: rpcpb.ResultInfo
	(*CallBackQueueMsg)(nil), // 2: rpcpb.CallBackQueueMsg
}
...
func file_mqant_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_mqant_rpc_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CallBackQueueMsg); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
